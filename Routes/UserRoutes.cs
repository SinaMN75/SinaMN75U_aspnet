...
public static class UserRoutes {
	public static void MapUserRoutes(this IEndpointRouteBuilder app, string name) {
		...
		route.MapPost("Filter", async (UserFilterParams d, IUserService s, CancellationToken c) => (await s.Filter(d, c)).ToResult()).Produces<UResponse<IEnumerable<UserEntity>>>();
