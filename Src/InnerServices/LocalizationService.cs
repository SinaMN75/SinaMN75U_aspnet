...
public class LocalizationService(IHttpContextAccessor httpContext) : ILocalizationService {
	private readonly Dictionary<string, string> _en = new() {
		...
		{ "InvalidChargeAmount", "The selected charge amount is not offered by this operator." },
		...
		{ "InvalidPath", "The requested path is invalid." },
		{ "PathNotFound", "The requested path was not found." },
		{ "PathAlreadyExists", "An item with this name already exists." },
		...
		{ "PrimaryKeyRequired", "Primary key is required." },
		{ "NoValuesToUpdate", "No values provided to write." },
		...
		{ "ParkingPlateFlagNotFound", "Plate Record Not Found." },
		{ "ParkingStaffNotFound", "Parking Staff Member Not Found." },
		{ "ParkingShiftNotFound", "Parking Shift Not Found." },
		{ "ParkingReportIsAlreadyClosed", "This Entry Has Already Been Closed." },
		{ "VehicleIsAlreadyInsideTheParking", "This Vehicle Is Already Inside The Parking." },
		...
		{ "HotelIsNotActive", "This hotel is currently not accepting reservations." },
		{ "CheckInDateIsInThePast", "The check-in date cannot be in the past." },
		{ "GuestCountExceedsRoomCapacity", "The number of guests is more than this room can take." },
		{ "ReservationAlreadyCancelled", "This reservation has already been cancelled." },
		{ "ReservationCannotBeCancelled", "A reservation that has already been checked in cannot be cancelled." },
		{ "ReservationCancelledSuccessfully", "The reservation was cancelled." },
		{ "InvoiceAlreadyPaid", "This invoice has already been paid." },
		{ "PaymentSuccessful", "Payment completed." },
		{ "ReservationCreatedTitle", "Reservation registered" },
		{ "ReservationConfirmedTitle", "Reservation confirmed" },
		{ "ReservationCancelledTitle", "Reservation cancelled" },
		{ "ReservationPaymentTitle", "Hotel reservation payment" },
		{ "ReservationRefundTitle", "Hotel reservation refund" },
		{ "DormInvoicePaymentTitle", "Dorm invoice payment" },
		{ "InvoicePaidTitle", "Invoice paid" },
		{ "InvoiceIssuedTitle", "New invoices issued" },
		...
		{ "IdempotencyKeyNotValid", "Idempotency key is not valid." },
		{ "OrderSideRequired", "Order side is required." },
		{ "ScopesRequired", "At least one scope is required." },
		{ "GoldAmountRequired", "Send exactly one of base amount or quote amount, greater than zero." },
		{ "GoldProviderNotConfigured", "The gold provider is not configured." },
		{ "GoldProviderUnavailable", "The gold provider is not reachable right now." },
		{ "GoldProviderError", "The gold provider returned an unexpected error." },
		{ "GoldValidationError", "The gold provider rejected the request data." },
		{ "GoldInvalidCursor", "The pagination cursor is invalid or expired. Start from the first page." },
		{ "GoldNotFound", "The requested gold resource was not found." },
		{ "GoldUnauthenticated", "Authentication with the gold provider is required." },
		{ "GoldInvalidCredentials", "The gold provider credentials are invalid." },
		{ "GoldInvalidToken", "The gold provider token is invalid or expired." },
		{ "GoldForbidden", "Access to this gold resource is denied." },
		{ "GoldIpNotAllowed", "This IP address is not allowed by the gold provider." },
		{ "GoldClientInactive", "The gold provider client account is inactive." },
		{ "GoldTokenNotFound", "The gold provider token was not found." },
		{ "GoldMaxActiveTokensReached", "The maximum number of active gold tokens has been reached. Revoke one first." },
		{ "GoldIpNotSubsetOfClient", "The token IP whitelist must be a subset of the client IP whitelist." },
		{ "GoldRateLimitExceeded", "Too many requests to the gold provider. Please try again shortly." },
		{ "GoldAuthRateLimited", "Too many failed authentication attempts. Please try again shortly." },
		{ "GoldBusinessSuspended", "Your gold business account is suspended." },
		{ "GoldUnsupportedTradePair", "This trade pair is not supported." },
		{ "GoldAssetPairMismatch", "The asset pair does not match the request." },
		{ "GoldAssetNotFound", "The asset was not found or is inactive." },
		{ "GoldInvalidTradeRequest", "The trade request is not valid." },
		{ "GoldInvalidTradeAmount", "The trade amount is not valid." },
		{ "GoldAmountPrecisionExceeded", "The amount has more decimal places than the asset allows." },
		{ "GoldInsufficientQuoteAmount", "The amount is below the minimum trade size." },
		{ "GoldDuplicateIdempotencyKey", "This idempotency key has already been used. Generate a new one for each order." },
		{ "GoldTradeWindowLimitExceeded", "Your order volume has reached the limit for the current time window." },
		{ "GoldOrderNotFound", "The order was not found." },
		{ "GoldInsufficientBalance", "Your gold wallet balance is not enough." },
		{ "GoldQuoteUnavailable", "The gold price is not available right now. Please try again shortly." },
		{ "GoldBalanceIsLow", "Your gold balance is not enough for this order." },
		{ "GoldWalletLocked", "Your gold wallet is locked." },
		{ "GoldTxnNotFound", "The gold transaction was not found." },
		{ "GoldOrderFailed", "The gold order was not completed. Any reserved amount has been returned." },
		{ "GoldOrderPending", "The gold order is being processed and will be settled shortly." }
	};
	...
	private readonly Dictionary<string, string> _fa = new() {
		...
		{ "ContentUpdated", "محتوا با موفقیت به‌روزرسانی شد." },
		{ "ContentDeleted", "محتوا با موفقیت حذف شد." },
		...
		{ "TooManyAttempts", "تعداد تلاش‌های ناموفق زیاد است. لطفاً بعداً دوباره امتحان کنید." },
		...
		{ "InvalidChargeAmount", "مبلغ شارژ انتخاب‌شده برای این اپراتور معتبر نیست." },
		...
		{ "InvalidPath", "مسیر درخواستی نامعتبر است." },
		{ "PathNotFound", "مسیر درخواستی یافت نشد." },
		{ "PathAlreadyExists", "موردی با این نام از قبل وجود دارد." },
		{ "Updated", "با موفقیت به‌روزرسانی شد." },
		{ "Created", "با موفقیت ایجاد شد." },
		{ "Deleted", "با موفقیت حذف شد." },
		{ "NotFound", "یافت نشد." },
		{ "TableRequired", "نام جدول الزامی است." },
		{ "SqlRequired", "دستور SQL الزامی است." },
		{ "PrimaryKeyRequired", "کلید اصلی الزامی است." },
		{ "NoValuesToUpdate", "هیچ مقداری برای ثبت ارائه نشده است." },
		...
		{ "ParkingPlateFlagNotFound", "رکورد پلاک یافت نشد." },
		{ "ParkingStaffNotFound", "کارمند پارکینگ یافت نشد." },
		{ "ParkingShiftNotFound", "شیفت یافت نشد." },
		{ "ParkingReportIsAlreadyClosed", "خروج این خودرو قبلاً ثبت شده است." },
		{ "VehicleIsAlreadyInsideTheParking", "این خودرو هم‌اکنون داخل پارکینگ است." },
		...
		{ "HotelIsNotActive", "این هتل در حال حاضر رزرو نمی‌پذیرد." },
		{ "CheckInDateIsInThePast", "تاریخ ورود نمی‌تواند در گذشته باشد." },
		{ "GuestCountExceedsRoomCapacity", "تعداد مهمان از ظرفیت این اتاق بیشتر است." },
		{ "ReservationAlreadyCancelled", "این رزرو قبلاً لغو شده است." },
		{ "ReservationCannotBeCancelled", "رزروی که پذیرش شده است قابل لغو نیست." },
		{ "ReservationCancelledSuccessfully", "رزرو لغو شد." },
		{ "InvoiceAlreadyPaid", "این فاکتور قبلاً پرداخت شده است." },
		{ "PaymentSuccessful", "پرداخت انجام شد." },
		{ "ReservationCreatedTitle", "رزرو ثبت شد" },
		{ "ReservationConfirmedTitle", "رزرو تایید شد" },
		{ "ReservationCancelledTitle", "رزرو لغو شد" },
		{ "ReservationPaymentTitle", "پرداخت رزرو هتل" },
		{ "ReservationRefundTitle", "استرداد وجه رزرو هتل" },
		{ "DormInvoicePaymentTitle", "پرداخت فاکتور خوابگاه" },
		{ "InvoicePaidTitle", "فاکتور پرداخت شد" },
		{ "InvoiceIssuedTitle", "فاکتورهای جدید صادر شد" },
		...
		// ===== Gold =====
		{ "IdempotencyKeyRequired", "کلید یکتای درخواست الزامی است." },
		{ "IdempotencyKeyNotValid", "کلید یکتای درخواست معتبر نیست." },
		{ "OrderSideRequired", "نوع سفارش (خرید یا فروش) الزامی است." },
		{ "ScopesRequired", "حداقل یک دسترسی الزامی است." },
		{ "GoldAmountRequired", "دقیقاً یکی از مقدار طلا یا مبلغ ریالی را بزرگ‌تر از صفر ارسال کنید." },
		{ "GoldProviderNotConfigured", "سرویس‌دهنده طلا پیکربندی نشده است." },
		{ "GoldProviderUnavailable", "در حال حاضر ارتباط با سرویس‌دهنده طلا برقرار نشد." },
		{ "GoldProviderError", "سرویس‌دهنده طلا خطای پیش‌بینی‌نشده برگرداند." },
		{ "GoldValidationError", "اطلاعات ارسالی به سرویس‌دهنده طلا نامعتبر است." },
		{ "GoldInvalidCursor", "کرسر صفحه‌بندی نامعتبر یا منقضی شده است. از صفحه اول شروع کنید." },
		{ "GoldNotFound", "منبع درخواستی در سرویس طلا یافت نشد." },
		{ "GoldUnauthenticated", "برای دسترسی به سرویس طلا باید احراز هویت شوید." },
		{ "GoldInvalidCredentials", "اعتبارنامه سرویس‌دهنده طلا نامعتبر است." },
		{ "GoldInvalidToken", "توکن سرویس‌دهنده طلا نامعتبر یا منقضی شده است." },
		{ "GoldForbidden", "دسترسی به این بخش از سرویس طلا مجاز نیست." },
		{ "GoldIpNotAllowed", "این آدرس IP از سوی سرویس‌دهنده طلا مجاز نیست." },
		{ "GoldClientInactive", "حساب کلاینت سرویس طلا غیرفعال است." },
		{ "GoldTokenNotFound", "توکن سرویس‌دهنده طلا یافت نشد." },
		{ "GoldMaxActiveTokensReached", "حداکثر تعداد توکن‌های فعال طلا تکمیل شده است. ابتدا یک توکن را باطل کنید." },
		{ "GoldIpNotSubsetOfClient", "لیست IP مجاز توکن باید زیرمجموعه لیست IP مجاز کلاینت باشد." },
		{ "GoldRateLimitExceeded", "تعداد درخواست‌ها به سرویس طلا بیش از حد مجاز است. کمی بعد دوباره تلاش کنید." },
		{ "GoldAuthRateLimited", "تعداد تلاش‌های ناموفق احراز هویت بیش از حد مجاز است. کمی بعد دوباره تلاش کنید." },
		{ "GoldBusinessSuspended", "حساب کسب‌وکار طلای شما معلق شده است." },
		{ "GoldUnsupportedTradePair", "این جفت معاملاتی پشتیبانی نمی‌شود." },
		{ "GoldAssetPairMismatch", "جفت دارایی ارسالی با درخواست مطابقت ندارد." },
		{ "GoldAssetNotFound", "دارایی یافت نشد یا غیرفعال است." },
		{ "GoldInvalidTradeRequest", "درخواست معامله نامعتبر است." },
		{ "GoldInvalidTradeAmount", "مقدار معامله نامعتبر است." },
		{ "GoldAmountPrecisionExceeded", "تعداد ارقام اعشار مقدار واردشده بیش از حد مجاز دارایی است." },
		{ "GoldInsufficientQuoteAmount", "مبلغ واردشده برای حداقل معامله کافی نیست." },
		{ "GoldDuplicateIdempotencyKey", "این کلید قبلاً استفاده شده است. برای هر سفارش یک کلید جدید بسازید." },
		{ "GoldTradeWindowLimitExceeded", "حجم سفارش‌های شما در بازه زمانی فعلی به حد مجاز رسیده است." },
		{ "GoldOrderNotFound", "سفارش یافت نشد." },
		{ "GoldInsufficientBalance", "موجودی کیف پول طلای شما کافی نیست." },
		{ "GoldQuoteUnavailable", "قیمت طلا در حال حاضر در دسترس نیست. کمی بعد دوباره تلاش کنید." },
		{ "GoldBalanceIsLow", "موجودی طلای شما برای این سفارش کافی نیست." },
		{ "GoldWalletLocked", "کیف پول طلای شما قفل است." },
		{ "GoldTxnNotFound", "تراکنش طلا یافت نشد." },
		{ "GoldOrderFailed", "سفارش طلا انجام نشد. مبلغ رزروشده به کیف پول شما بازگشت." },
		{ "GoldOrderPending", "سفارش طلا در حال پردازش است و به‌زودی تسویه می‌شود." }
	};
